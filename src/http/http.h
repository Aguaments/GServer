...
namespace agent{
    namespace http{
        ...
        public:
            ...
            template<class T>
            bool getParamsAs(const std::string& key, const T& def = T()){
        ...
        public:
            ...
            template<class T>
            bool checkGetHeaderAs(const std::string& key, T& val, const T& def){
                return checkGetAs(m_headers, key, val, def);
            }

            template<class T>
            bool getHeaderAs(const std::string& key, const T& def){
                return getAs(m_headers, key, def);
            }
